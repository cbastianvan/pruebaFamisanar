...
import com.dev.famisanar.MainActivity;
import com.dev.famisanar.R;
import com.dev.famisanar.image;
import com.dev.famisanar.webviewActivity;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v == mView) {
                ...
                intent.putExtra("descriptionHtml",child.getData().getContest_mode());
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.author.setText("Contenido: " + child.getData().getAudience());
        holder.subreddit.setText("Categoria: " + child.getData().getCategory());
